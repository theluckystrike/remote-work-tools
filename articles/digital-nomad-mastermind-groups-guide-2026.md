...
| 15-50 min | Deep detailed look on one member's challenge (rotating) |
...
- Commitment completion rate: What percentage of stated commitments get completed?
- Member retention: How long do members stay active?
- Value perception: Rate meetings on usefulness (1-5) after each session
- Goal achievement: Annual review of stated goals versus actual outcomes
...
- Group manifesto: Document your group's values and operating principles
- Cohort naming: Give your group a name that builds identity
- Milestone celebrations: Acknowledge when members achieve goals
- Resource libraries: Accumulate shared bookmarks, templates, and tools
...
- Problem deep detailed look (30 min): The one issue consuming mental energy
