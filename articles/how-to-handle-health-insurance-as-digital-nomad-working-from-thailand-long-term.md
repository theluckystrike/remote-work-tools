...
## Local Thai Health Insurance vs International Plans
...
local_thai_plan:
  ...
  hospitals_covered: "Bangkok Hospital, Samitivej, Bumrungrad"
...
providers:
  safetywing:
    monthly_cost: ~$42-84
    coverage_area: "Global (excluding some countries)"
    deducible: "$250-500"

  cigna_global:
    monthly_cost: ~$200-500+
    coverage_area: "Global"
    deducible: "Customizable"

  Allianz_international:
...
## Estimating Healthcare Costs in Thailand
...
healthcare_costs = {
    "doctor_consultation": {
        ...
        "hospital_specialist": 80-150
    },
    "emergency_room": 150-500,
    "dental_checkup": 30-80,
    "dental_cleaning": 50-100,
    "prescription_medications": 10-100,
    "mri_scan": 300-600,
    "surgery_appendectomy": 2000-5000,
    "icu_per_day": 500-1500
}
```
...
- Remote worker category: Proof of $500,000 in savings OR $80,000+ annual income. Insurance not mandatory but recommended for visa stability
...
## Working with Thai Healthcare Systems
...
## Thailand-Specific Health Risks for Remote Workers
...
## Renewal and Policy Persistence
