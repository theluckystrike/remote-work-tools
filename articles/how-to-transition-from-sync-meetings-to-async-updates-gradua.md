...
Ignoring time zones defeats the purpose. Async works best when everyone has reasonable overlap for essential discussions. If your team spans twelve time zones, accept that some real-time interaction remains necessary.
