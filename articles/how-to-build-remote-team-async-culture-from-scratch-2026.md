...
When a new engineer joins, they read the onboarding guide in the wiki, not wait for someone to explain it verbally.
...
Week 2
- [ ] Detailed look on your team's codebase (read docs/code comments)
