...
STC 35 window + STC 35 insert with 4" gap at 500 Hz
...
bookshelf_config:
  ...
  material_impact:
    ...
    - "Absorption: paper and absorb mid-high frequencies"
```
...
How long does it take to set up a soundproof home office when working?
