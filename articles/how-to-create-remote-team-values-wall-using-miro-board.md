...
- Behaviors they've seen that made teams successful
- Qualities they admire in colleagues
- Principles they want guiding their work
- How they'd like to be treated by teammates
- What inspired them to join this organization
...
- Why you chose async-first communication (aligned with your "respect for deep work" value)
- How you decided to maintain a smaller team rather than hire quickly (aligned with "sustainable pace" or "quality over speed")
- Why you open-sourced parts of your codebase (aligned with "learning" and "community")
...
- Create a read-only shared link for team reference
- Pin the board to your team Slack channel or wiki
- Use the board's presentation mode during onboarding sessions
- Keep the board updated as values evolve (never archive it)
