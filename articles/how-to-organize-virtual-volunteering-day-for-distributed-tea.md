...
- Individual skills that could benefit (coding, design, mentoring, writing)
...
Find overlap for team across NYC, London, Tokyo
...
```yaml
Slack Workflow YAML structure (import into Workflow Builder)
workflow:
...
- 15 min: Detailed look on specific topic
