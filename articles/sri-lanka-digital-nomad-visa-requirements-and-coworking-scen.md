...
1. Completed extension application form
2. Passport with ETA endorsement
3. Proof of accommodation (rental agreement or hotel booking)
4. Evidence of sufficient funds for extended stay
...
Hire a local visa agent ($50-100) if you're unfamiliar with the process. They handle everything, forms, photography, submission. Time saved often justifies the cost.
