...
```yaml
Slack channel structure for timezone-inclusive social
channels:
  - name: "random"
...
- New hires get assigned as "social ambassadors" for their first month, responsible for welcoming and starting conversations
