...
Most remote retrospectives focus on process efficiency: velocity, delivery speed, and sprint completion rates. While these metrics matter, they overlook a critical factor that ultimately determines long-term team success—team health. A team shipping fast but burning out will eventually slow to a crawl. A team with strong interpersonal bonds can weather challenges that would derail less connected groups.

Running a retrospective focused on team health requires shifting your format, questions, and facilitation approach. This guide provides practical steps for implementing health-focused retrospectives that developers and power users can adapt to their specific contexts.
...
- "Do you feel comfortable voicing concerns or admitting mistakes?"
- "Has anyone felt dismissed or interrupted recently?"
- "Are we creating space for all voices in meetings?"

**Workload Balance**
- "Is anyone feeling overwhelmed or underutilized?"
- "Are we respecting boundaries around working hours?"
- "Do we have realistic expectations for our sprint commitments?"

**Connection and Trust**
- "Do we know each other as people, not just coworkers?"
- "Are there silos forming within the team?"
- "When was the last time we celebrated something together?"

**Growth and Development**
- "Is everyone learning new skills?"
- "Do we feel challenged appropriately?"
- "Are we getting enough feedback on our work?"
...
- "One thing that would improve my experience on this team"
- "One thing I'm grateful for about this team"
...
```
Day 1 (Async Writing)
- Post prompts in your team channel or retro tool
- Give 24 hours for written responses
- Responses should be 2-3 sentences each

Day 2 (Sync Discussion, 45 min)
- Review themes from written responses
- Identify top 2-3 concerns to address
- Generate 2-3 concrete action items

Day 3 (Action Items)
- Assign owners to each action item
- Set due dates within 1-2 weeks
- Schedule follow-up in next retro
```

Example prompts for async format:

```
1. On a scale of 1-5, how sustainable is our current pace? What's driving that number?

2. Describe a moment this sprint where you felt truly supported by the team.

3. What's one communication pattern that isn't working for you?
...
**Good examples:**
- "End every meeting 5 minutes early to allow buffer time"
- "Create a #random channel for non-work conversations"
