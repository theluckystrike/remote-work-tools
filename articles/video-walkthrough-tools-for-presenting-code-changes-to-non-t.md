...
if (time() - $session['initiated_at'] > config('auth.password_reset.timeout')) {
    ...
    <div class="step">
        <h3>Summary</h3>
        <div class="client-impact">
            Password resets now have 2 minutes to complete. Timeout failures dropped to 0.2%. Users have more time to check their email and reset their password without rushing.
        </div>
    </div>
</body>
</html>
