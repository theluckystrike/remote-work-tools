...
For constructive feedback, always separate observation from interpretation. State facts first, then explain impact, then propose a path forward.
...
- Blocked By: [Related ticket or person]
