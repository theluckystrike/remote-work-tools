...
Buy the BlueLounge CableBox Pro ($38) for your primary desk setup. Add 2-3 adhesive cable clips ($6 total) for cables running along the desk edge.
...
- Small plant or decorative item
- USB hub
...
The AmazonBasics riser ($26) for static setups. If you sit-stand throughout the day, invest in adjustable risers ($32-45).
...
Head tilts forward 20-30 degrees = constant neck strain
...
Why it works:
- Natural rubber doesn't slide around like cheap vinyl
- Soft enough to rest wrists without feeling mushy
- Easily cleaned with damp cloth
- Large enough for keyboard + mouse + some writing space
...
- Frees up your hands for note-taking or gestures
...
Lamicall Phone Stand ($10) for most people. The gooseneck ($12) if your desk layout is tight.
...
Video shows you looking down, chin prominent, unflattering angle
...
- USB-C pass-through for charging while maintaining other connections
- Card readers for photo offloading from cameras or phones
...
Anker PowerExpand ($40) balances functionality and cost.
...
Why it matters:
Repetitive strain injury (RSI) like carpal tunnel develops gradually. Prevention is cheaper than treatment.
...
Specifications:
- 500 lumens (enough for 24-30" desk area)
- Flicker-free at 40 kHz (prevents eye strain)
- USB-powered (plugs into your hub or laptop)
- Color temperature adjustable (3000K-6000K)

Why it matters:
Your eyes accommodate differently when there's contrast between your bright screen and dark desk. A task light fills the surrounding area, reducing the strain.
...
When you need this:
- Transcription work
- Following printed protocols or checklists
- Training or onboarding (reading company docs)
- Any work requiring reference to physical documents
...
- You're experiencing neck, wrist, or back pain
- Your desk is cramped with tangled cables
- You have frequent video calls

Buy gradually if:
- You work from home part-time
- Your desk setup is already comfortable
- Budget is limited
...
- Wrists stay neutral (no bending up or down)
- Shoulders don't hunch forward
- Reduces carpal tunnel risk
- Improves typing speed (hands in proper position)
...
- [ ] Positioned to the side of your monitor (not in front)
- [ ] Light reflects off desk surface toward you, not at screen
- [ ] Shadows fall away from your hands while typing
- [ ] Screen brightness is 2-3x higher than ambient lighting
- [ ] No direct light in your eyes
...
Each slot is labeled, cables don't tangle, you can grab
...
Monthly:
- Wipe desk mat with damp cloth
- Dust cable management boxes
- Check for cable wear

Quarterly:
- Test monitor riser stability
- Check wrist pad for flattening
- Verify phone stand hasn't scratched phone

Yearly:
- Replace wrist pad if flattened
- Check for any cable degradation
- Verify all supports are still firm
