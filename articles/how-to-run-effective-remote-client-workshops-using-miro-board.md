...
categories: [guides]
tags: [remote-work, client-workshops, miro, virtual-meetings, collaboration-tools, workshop-facilitation]
reviewed: true
score: 8
intent-checked: true
voice-checked: true
...
Effective facilitation makes the difference between a productive session and a wasted meeting. Apply these techniques when running remote client workshops:
