...
- Fold time: 3 seconds (compact profile)
...
- Marble/glass: Risk of stand sliding; adhesive backing preferable to just friction
- Wood tables: Safe but variable height if warped
- Portable tables: May be unstable under keyboard pressure; use heavier stands
...
- Table width: 36-48 inches
- Laptop footprint: 12-14 inches
- Stand footprint: 6-9 inches
...
- Power cables must reach from outlets (often counter-level)
- USB cables for external mouse/keyboard add clutter
