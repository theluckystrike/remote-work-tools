...
- Maintains single schema, easier application code
- Requires rebalancing logic, 4-week implementation
...
- Faster to implement (1 week), better for analytics queries
- Different schema syntax, requires application rewrite
