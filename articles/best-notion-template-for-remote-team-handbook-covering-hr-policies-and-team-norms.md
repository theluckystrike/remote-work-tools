...
- **Use consistent tagging**: Tag all policies by category (remote-work, benefits, process)
2.
- **Use database filtering**: Create filtered views for "policies affecting me" by role
5.
