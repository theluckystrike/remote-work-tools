...
permalink: /remote-team-hiring detailed lookrsity-sourcing-strategy-for-distributed-companies/
categories: [guides]
...
- [Onboarding That Retains Diverse Talent](#onboarding-that-retains detailed lookrse-talent)
...
```python
Tracking diversity sourcing channel effectiveness
