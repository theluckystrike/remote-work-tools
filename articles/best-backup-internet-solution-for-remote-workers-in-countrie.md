...
```bash
Configuring a GL.iNet router for automatic failover
...
- Dual-SIM MiFi router as primary backup
...
- Starlink with local cellular backup
...
- UPS + secondary terrestrial connection
...
- MiFi with multiple carrier options
