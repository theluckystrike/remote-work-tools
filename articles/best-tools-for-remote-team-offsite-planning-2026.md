...
3. Browse available properties with team capacity
4. Book properties with centralized payment
...
3. Invite team members; they book flights and hotels through TravelPerk
4. Platform tracks all expenses, flags policy violations
...
2. Curated activity options
3. Group dining reservations
...
3. Corporate card can be loaded for the event
4. All expenses tracked automatically
