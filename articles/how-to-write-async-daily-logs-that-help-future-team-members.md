...
If three daily log entries mention "confusion around acceptance criteria format," create a formal guide, then link back to the logs that prompted it. This creates a visible trail of documentation evolution.
