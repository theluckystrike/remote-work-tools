...
1. **What happened?** — Factual description, avoiding interpretation
2. **What did you expect to happen?** — Each person's assumptions
3. **What impact did this have?** — Focus on outcomes, not intentions
4. **What would you like to see going forward?** — Forward-looking resolution
...
1. **Document everything** — Compile the factual history without interpretation
