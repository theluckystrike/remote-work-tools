...
Done, intuitive, everyone can see alignment immediately.
...
Strong, but requires dedicated OKR person to understand cascade rules.
...
Intuitive, team leads can do this without ops help.
...
Flexible, but feels fragile (easy to break rollups).
...
OKR tool shows "Platform latency KR: 42% of GitHub PRs merged, estimated 15% latency reduction achieved"
```
