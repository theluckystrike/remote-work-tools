...
High context switching and evening work detected.
...
- Weekly check-in "How stressed are you 1-10?" → Trend analysis → Manager notified if score drops significantly
...
```
Every day at 12pm:
→ Post to #general: "Time for lunch! Step away from desk for 30 min "
